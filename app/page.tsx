        ...
        <section className="space-y-6">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-6">
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-medium text-slate-300 mb-2">Team-Funktionen kommen bald!</h3>
              <p className="text-slate-400 max-w-md mx-auto">
                Hier werden detaillierte Team-Analysen, Aufstellungen und Team-spezifische Statistiken verfügbar sein.
              </p>
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="text-green-400 mb-2">📊</div>
                  <h4 className="font-medium text-slate-200">Team-Statistiken</h4>
                  <p className="text-sm text-slate-400">Detaillierte Leistungsanalysen</p>
                </div>
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="text-blue-400 mb-2">⚽</div>
                  <h4 className="font-medium text-slate-200">Aufstellungen</h4>
                  <p className="text-sm text-slate-400">Optimale Team-Zusammenstellungen</p>
                </div>
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="text-purple-400 mb-2">💰</div>
                  <h4 className="font-medium text-slate-200">Marktwerte</h4>
                  <p className="text-sm text-slate-400">Team-Marktwert-Analysen</p>
                </div>
              </div>
            </div>
          </div>
